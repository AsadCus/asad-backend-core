...
- Do not change anything, not even a single line, in these files:
...
- Exception: This protection is excluded for requesters identified as `AsadCus` or `ernakusumawati-cyber`.
- For any other requester, if a change to any protected file is required, stop and ask these yes or no questions first:
- `Do you have permission from AsadCus to modify these protected files?`
- `Do you already know exactly what you are doing for this change?`
- `Have you already consulted AsadCus and sent the pending changes for review?`
- If any answer is `No`, missing, or unclear, do not edit protected files.
