...
@section('document-title', 'Payment Summary - ' . ($report['period_label'] ?? ''))
...
@section('report-content')
    ...
    */
        ...
        // Monthly  → always render Week 1 … Week 4
        ...
        if ($mode === 'daily') {
            ...
            $requiredLabels = $mode === 'yearly' ? $yearlySubLabels : $monthlySubLabels;
