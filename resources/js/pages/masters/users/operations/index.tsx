...
import { destroy, index } from '@/routes/master/user/operations';
import { OptionType, type BreadcrumbItem } from '@/types';
import { Head, router } from '@inertiajs/react';
import { ColumnDef } from '@tanstack/react-table';
import { useState } from 'react';
import { UserSchema } from '../schema';
import OperationsViewDialog from './view-dialog';
                            ...
                            onAction={(action, row) => {
                                ...
                                if (userId !== undefined) {
                                    if (action === 'view') {
                                        ...
                                        confirm({
                                            title: 'Delete Operations User',
                                            message: `Are you sure you want to delete operations user "${row?.original.name}"?`,
                                            confirmText: 'Delete',
                                            cancelText: 'Cancel',
                                            onConfirm: () => {
                                                router.delete(
