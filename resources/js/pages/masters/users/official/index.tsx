...
import { destroy, index } from '@/routes/master/user/official';
import { OptionType, type BreadcrumbItem } from '@/types';
import { Head, router } from '@inertiajs/react';
import { ColumnDef } from '@tanstack/react-table';
import { useState } from 'react';
import { UserSchema } from '../schema';
import OfficialViewDialog from './view-dialog';
...
export default function Official({ dataUser, dataRole }: OfficialProps) {
            ...
            <AppLayout breadcrumbs={breadcrumbs}>
                ...
                <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                    <div className="flex items-center justify-between">
                        <h2 className="text-lg font-semibold">Official</h2>
                    </div>
                                ...
                                if (userId !== undefined) {
                                    if (action === 'view') {
                                        ...
                                        confirm({
                                            ...
                                            message: `Are you sure you want to delete official "${row?.original.name}"?`,
                                            confirmText: 'Delete',
                                            cancelText: 'Cancel',
                                            onConfirm: () => {
                                                router.delete(
