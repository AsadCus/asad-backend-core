...
export const memberSchema = z.object({
    ...
    date_of_third_payment: z.string().nullable().optional(),
    third_payment: z.coerce.number().nullable().optional(),
    balance_due: z.coerce.number().nullable().optional(),
    receipt_1: z.string().nullable().optional(),
    receipt_2: z.string().nullable().optional(),
    receipt_3: z.string().nullable().optional(),
