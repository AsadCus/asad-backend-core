...
function Breadcrumb({
    ...
    return (
        <nav className="flex flex-wrap items-center gap-1.5 text-base text-muted-foreground">
            {items.map((item, i) => (
            ...
            <div className="mx-auto max-w-5xl px-8 py-8">
                ...
                <div className="mt-8 rounded-2xl border border-dashed border-sidebar-border/70 p-12 text-center">
                    ...
                    <button
                        ...
                        className="mt-4 text-base text-orange-600 hover:underline"
                    >
                        ← Back to {moduleName}
                    </button>
                </div>
        ...
        <div className="resource-content-wrap mx-auto max-w-5xl px-8 py-8">
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        <div className="flex flex-wrap items-start justify-between gap-2">
                            ...
                            <span className="rounded-full bg-primary/5 px-3 py-1 text-sm font-semibold text-primary dark:bg-primary/40 dark:text-primary-foreground">
                        ...
                        <div className="mt-3 flex items-center justify-between gap-2">
                            {previousHref ? (
                                <Link
                                    ...
                                    replace={false}
                                    className="group inline-flex items-center gap-1.5 rounded-lg border border-sidebar-border/70 bg-slate-50 px-3 py-1.5 text-sm font-medium text-muted-foreground hover:border-primary/20 hover:bg-primary/5 hover:text-primary dark:border-slate-800 dark:bg-slate-950/40 dark:hover:border-primary/60 dark:hover:text-primary-foreground"
                                >
                                ...
                                <span className="inline-flex items-center gap-1.5 rounded-lg border border-dashed border-sidebar-border/70 px-3 py-1.5 text-sm text-muted-foreground/40 dark:border-slate-800">
                                    <ArrowLeft className="h-3.5 w-3.5" />
                                    No previous
                                </span>
                            )}
                        ...
                        {procedure.steps.map((step, i) => {
                            ...
                            const renderStepText = (content: string) => {
                                ...
                                if (match) {
                                    ...
                                    if (type === 'note') {
                                        return (
                                            <div className="tips-note mt-1 mb-2 rounded-lg border border-orange-200 bg-orange-50 p-3 text-base text-orange-800 dark:border-orange-900/50 dark:bg-orange-950/30 dark:text-orange-300">
                                        ...
                                        return (
                                            <div className="tips-insight mt-1 mb-2 rounded-lg border border-blue-200 bg-blue-50 p-3 text-base text-blue-800 dark:border-blue-900/50 dark:bg-blue-950/30 dark:text-blue-300">
                                                <strong className="font-semibold">
                                                    Insight:
                                                </strong>{' '}
                                                {textBody}
                                        ...
                                        return (
                                            <div className="tips-prerequisites mt-1 mb-2 rounded-lg border border-green-200 bg-green-50 p-3 text-base text-green-800 dark:border-green-900/50 dark:bg-green-950/30 dark:text-green-300">
                                                <strong className="font-semibold">
                                                    Prerequisite:
                                                </strong>{' '}
                                                {textBody}
                            ...
                            return (
                                ...
                                >
                                    {/* Step number */}
                                    <div className="relative z-10 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border-2 border-primary/20 bg-white text-base font-bold text-primary dark:border-primary/60 dark:bg-slate-900 dark:text-primary-foreground">
                                        {i + 1}
                                    </div>
            ...
            <div className="mt-8 flex items-center justify-between pb-8">
                <button
                    type="button"
                    onClick={onBackToModule}
                    className="inline-flex items-center gap-2 rounded-lg border border-sidebar-border/70 px-4 py-2 text-base font-medium text-muted-foreground shadow-sm hover:bg-slate-50 hover:text-foreground dark:hover:bg-slate-900"
                >
                    ← Back to {moduleName}
                </button>
                <button
                    ...
                    className="rounded-lg px-4 py-2 text-base font-medium text-orange-600 hover:bg-orange-50 dark:text-orange-400 dark:hover:bg-orange-950/30"
                >
                    Back to top
                </button>
            </div>
