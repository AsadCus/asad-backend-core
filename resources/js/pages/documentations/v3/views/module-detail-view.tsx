                ...
                {highlights.length > 0 && (
                    <div className="mt-5 flex flex-wrap gap-2">
                        {highlights.map((h) => (
                            <span
                                key={h}
                                className="rounded-full bg-primary/5 px-3 py-1 text-sm font-medium text-primary dark:bg-primary/40 dark:text-primary-foreground"
                            >
                                {h}
                            </span>
                        ))}
                ...
                {moduleGroup.route_path && (
                    <div className="mt-4">
                        <a
                            ...
                            className="inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-primary/90"
                        >
                ...
                <div className="mt-4 space-y-3">
                    {procedures.length > 0
                        ? procedures.map((proc, i) => (
                              ...
                              >
                                  <div className="flex items-start gap-4">
                                      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary/5 text-base font-bold text-primary dark:bg-primary/80 dark:text-primary-foreground">
                        ...
                        : moduleGroup.how_to.map((item, i) => (
                              ...
                              >
                                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-base font-bold text-slate-600 dark:bg-slate-800 dark:text-slate-300">
                                      {String(i + 1).padStart(2, '0')}
                                  </span>
