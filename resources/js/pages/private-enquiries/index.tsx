...
const columns: ColumnDef<PrivateEnquiryDatatableSchema>[] = [
    ...
    {
        accessorKey: 'mekkah_or_madinah_first',
        header: 'Mekkah/Madinah First',
        meta: { exportable: true },
    },
    {
        accessorKey: 'no_of_nights_mekkah',
        header: 'Nights in Mekkah',
        meta: { exportable: true },
    },
    {
        accessorKey: 'hotel_mekkah',
        header: 'Hotel Mekkah',
        meta: { exportable: true },
    },
    {
        accessorKey: 'meals_mekkah',
        header: 'Meals Mekkah',
        meta: { exportable: true },
    },
    {
    ...
    {
        accessorKey: 'mekkah_tour_with_mutawif',
        header: 'Mekkah Tour w/ Mutawif',
        meta: { exportable: true },
        cell: (info) => renderBoolean(info.getValue() as boolean),
    },
    {
                        ...
                        <DataTable
                            ...
                            initialState={{
                                ...
                                columnVisibility: {
                                    ...
                                    mekkah_or_madinah_first: false,
                                    no_of_nights_mekkah: false,
                                    hotel_mekkah: false,
                                    meals_mekkah: false,
