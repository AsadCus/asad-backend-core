...
class EnquirySeeder extends Seeder
{
    ...
    private const PRIVATE_HOTELS_MAKKAH = [
        'Mekkah Hotel & Towers',
        'Swissotel Mekkah',
        'Hilton Suites Mekkah',
        'Jumeirah Jabal Omar Mekkah',
        'Fairmont Mekkah Clock Royal Tower Hotel',
        'Address Jabal Omar Mekkah',
        'Swissotel Maqam',
        'Hyatt Jabal Omar',
        'InterContinental Dar Al Tawhid Mekkah',
        'Hilton Convention Mekkah',
        'Conrad Jabal Omar',
    ...
    private function seedPrivateEnquiries(): void
    {
        ...
        for ($index = 0; $index < self::PRIVATE_ENQUIRY_COUNT; $index++) {
            ...
            $privateEnquiries[] = [
                ...
                'mekkah_or_madinah_first' => fake()->randomElement(['Mekkah', 'Madinah']),
                'no_of_nights_mekkah' => fake()->randomElement(self::PRIVATE_NIGHTS_MAKKAH),
                'hotel_mekkah' => fake()->randomElement(self::PRIVATE_HOTELS_MAKKAH),
                'meals_mekkah' => fake()->randomElement(self::PRIVATE_MEAL_OPTIONS),
                ...
                'mekkah_tour_with_mutawif' => fake()->boolean(),
        ...
        foreach ($privateEnquiries as $data) {
            ...
            PrivateEnquiry::create([
                ...
                'mekkah_or_madinah_first' => $data['mekkah_or_madinah_first'],
                'no_of_nights_mekkah' => $data['no_of_nights_mekkah'],
                'hotel_mekkah' => $data['hotel_mekkah'],
                'meals_mekkah' => $data['meals_mekkah'],
                ...
                'mekkah_tour_with_mutawif' => $data['mekkah_tour_with_mutawif'],
