...
class EmailDispatchTestSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (method_exists($user, 'assignRole') && ! \Spatie\Permission\Models\Role::where('name', 'customer')->exists() === false) {
        ...
        $branchId = \App\Models\Branch::first()->id ?? null;
        $countryId = \App\Models\Country::first()->id ?? null;
