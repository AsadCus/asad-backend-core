                ...
                'procedures' => [
                    ...
                    [
                        ...
                        'steps' => [
                            ...
                            'Add the quotation date and validation date.',
                            'In the Description field, enter the title of the quotation accordingly.',
                            'Select either Instalments or Full Payment.',
                            'Click Add Items.',
                    ...
                    [
                        ...
                        'steps' => [
                            ...
                            'Click any of the generated quotation.',
                            'Change details as required.',
                            'Change status to Ready.',
                            'Click Update.',
                            '03        Convert Quotation to Invoice',
                        ],
                    ],
                    [
                        ...
                        'steps' => [
                            ...
                            'Once the quotation is accepted, an Order Form will be generated (see image above)',
            ...
            [
                ...
                'procedures' => [
                    ...
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            'Click and hold the 6-dot icon located on the far left of the table row',
                            'Drag the customer into the intended group',
                            'Click Reset This Room List Structure',
                            'Select either:',
                        ],
                    ],
                    [
