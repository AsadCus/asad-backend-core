            ...
            [
                ...
                'procedures' => [
                    ...
                    [
                        ...
                        'steps' => [
                            'Enquiry Modules',
                            'Click on Products and Services Menu',
                            'Click Add',
            ...
            [
                ...
                'procedures' => [
                    ...
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            'Go to the General Enquiry menu',
                    ...
                    [
                        ...
                        'steps' => [
                            'Customer',
                            'Go to the Private Enquiry menu',
            ...
            [
                ...
                'procedures' => [
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            'Select the Daily Received menu',
                    ...
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            'Select the Closing Report menu',
                    ...
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            '1. Click on the Quotation menu.',
                            '2. Click Create New Quotation.',
                            '3. In the Customer section, do not select any Umrah customer package.',
                            '4. Select the customer that has already been added to the customer list.',
                            '5. Add the quotation date and validation date.',
                            'Note: The grand total will be auto-generated automatically.',
                            '6. In the Description field, enter the title of the quotation accordingly.',
                            '7. Select either Instalments or Full Payment. (Note: This can still be edited later during invoicing.)',
                            '8. Click Add Items.',
                            '9. Select the required item (e.g. Aqiqah).',
                            '10. Add the item description in the description box below the selected item.',
                            '11. Enter the quantity and cost.',
                            '12. Add any extension such as discounts for individual items if required, or leave blank.',
                            '13. Add a total quotation discount if applicable.',
                            '14. Add any additional charges if required.',
                            '15. Edit the notes section if necessary.',
                            '16. Under Status, select Ready for Conversion if the quotation will later be converted into an invoice.',
                            '17. Click Create.',
                        ],
                    ],
                    [
                    ...
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            '1. Click on the Confirmed Customer menu.',
                            '2. Select the customer and click the option to Create Quotation.',
                            '3. In the quotation pop-up, review the list of members.',
                            '4. For members who require separate quotations, click the payee dropdown beside their names.',
                            '5. Select the respective Payer name for each member that requires a separate quotation.',
                            '6. Click Close after updating all required payees.',
                            '7. Review the quotation arrangement carefully.',
                            '8. Click Create Quotation.',
                            'Note: Multiple quotations will be automatically created based on the selected payees. You may split the quotations into as many separate quotations as needed, depending on the total number of members in the group.',
                            '9. The quotations will now appear in the quotation list as draft.',
                            '10. Click any of the generated quotation to open it.',
                            '11. Change details as required.',
                            '12. Change status from Draft to Ready.',
                            '13. Click Update.',
                            'Note: Quotation status must be Ready in order to convert to Invoice.',
                        ],
                    ],
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            '1. Go to the List of Quotations menu.',
                            '2. Click Options and change the quotation status to Accept Quotation.',
                            '3. Once the quotation is accepted, an Order Form will be automatically generated by the system before the invoice is created.',
                            '4. For a full payment invoice, select Full Payment under the Payment Plan section.',
                            '5. Click Expand All to review the invoice details.',
                            '6. Change the Invoice Name if required.',
                            '7. Select the preferred Payment Method.',
                            'Note: Payment charges are pre-defined in the Payment Extension settings. For example, payment via Visa may include an additional 3% charge on the total invoice amount. Payment Extension settings can be edited in the Product and Services section.',
                            '8. Change the Invoice Date and Due Date if required.',
                            '9. Add items if required.',
                            '10. Add discounts if required.',
                            '11. Click Create.',
                            'Note: The invoice will be generated for the confirmed customer and will appear in the Invoice menu. To edit the invoice, go to the Order menu, right-click on the customer name, and select Edit.',
                        ],
                    ],
                    [
                ...
                'procedures' => [
                    ...
                    [
                        ...
                        'steps' => [
                            ...
                            'Move the customer to a new package by selecting the desired package from the list',
                            'Click Move Selected Members',
                            'Note: The selected members will now be assigned to the new package.',
                            'Go to the Confirmed Customer menu',
                            'Expand the customer details',
            ...
            [
                ...
                'procedures' => [
                    ...
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            '1. Scroll to "Flight Details Section".',
                            '2. Enter the flight route description/header (e.g., "Singapore to Jeddah via Doha").',
                            '3. From: Select the departure airport from the dropdown (e.g., Singapore, Kuala Lumpur).',
                            '4. To: Select the arrival/destination airport from the dropdown (e.g., Jeddah for Umrah, Amman for Jordan).',
                            '5. Airline: Enter the airline name and flight number.',
                            '6. PNR: Enter the 6-digit airline booking reference code (confirm with the booking agent).',
                            '7. Departure Date/Time: Click the calendar picker, select the departure date and time.',
                            '8. Arrival Date/Time: Click the calendar picker, select the arrival date and time.',
                            '9. Click Save.',
                        ],
                    ],
                    [
            ...
            [
                ...
                'procedures' => [
                    ...
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            '1. Navigate to Room List – (Location 01).',
                            '2. Drag & Drop: Click and hold the 6-dot icon located on the far left of the table row, then drag the customer into the intended room group.',
                            ...
                            '3. To reset the room structure, click "Reset This Room List Structure".',
                            '4. Select the target replication source if applicable (e.g., replicate from an existing structure).',
                            '5. Click Update Manifest to save changes.',
                        ],
                    ],
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            '1. Navigate to Room List – (Location 02).',
                            '2. Drag & Drop: Click and hold the 6-dot icon located on the far left of the table row, then drag the customer into the intended room group.',
                            'Business Rule: Customers must belong to the same pricing plan in order to be grouped together. Otherwise, the system will prompt an over-capacity or mismatch error.',
                            '3. To replicate room arrangement from Location 01, click "Reset This Room List Structure".',
                            '4. Select "Location 01" as the source to duplicate the room structure.',
                            '5. Click Update Manifest to save changes.',
                        ],
                    ],
                    [
                    ...
                    [
                        ...
                        'status' => 'done',
                        'steps' => [
                            '1. Navigate to the Receipt section under Upload Documents.',
                            '2. Click Upload Receipt to attach bank transfer confirmations or receipts.',
                            ...
                            '3. Click Save to maintain audit traceability.',
                        ],
                    ],
                ],
            ],
