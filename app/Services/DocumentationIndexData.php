...
class DocumentationIndexData
{
    ...
    public static function getMenuStructure(): array
    {
        return [
            ...
            [
                'menu' => 'Ops Movement',
                'children' => ['Operations Movement', 'PIF', 'Itinerary', 'Booklet', 'Budget'],
            ],
        ];
    }
    ...
    public static function getMenuGroups(): array
    {
        return [
            ...
            [
                ...
                'features' => [
                    'Create New Package with comprehensive details',
                ],
                'how_to' => [],
            ],
            [
                ...
                'features' => [
                    'Main Dashboard',
                    'Airline Name List and Room List',
                    'Name List Course & Collection Item',
                    'Upload flight, visa, hotel, and other documents',
                ],
                'how_to' => [],
            ],
            [
