        ...
        $data = PrivateEnquiry::query()
            ...
            ->map(function ($privateEnquiry) {
                return [
                    ...
                    'mekkah_or_madinah_first' => $privateEnquiry->mekkah_or_madinah_first,
                    'no_of_nights_mekkah' => $privateEnquiry->no_of_nights_mekkah,
                    'hotel_mekkah' => $privateEnquiry->hotel_mekkah,
                    'meals_mekkah' => $privateEnquiry->meals_mekkah,
                    ...
                    'mekkah_tour_with_mutawif' => $privateEnquiry->mekkah_tour_with_mutawif,
    ...
    public function store(array $data = []): PrivateEnquiry
    {
        return DB::transaction(function () use ($data) {
            ...
            $privateEnquiry = PrivateEnquiry::create([
                ...
                'mekkah_or_madinah_first' => $data['mekkah_or_madinah_first'] ?? null,
                'no_of_nights_mekkah' => $data['no_of_nights_mekkah'] ?? null,
                'hotel_mekkah' => $data['hotel_mekkah'] ?? null,
                'meals_mekkah' => $data['meals_mekkah'] ?? null,
                ...
                'mekkah_tour_with_mutawif' => $data['mekkah_tour_with_mutawif'] ?? false,
    ...
    public function update(array $data, int $id): PrivateEnquiry
    {
        return DB::transaction(function () use ($data, $id) {
            ...
            $privateEnquiry->update([
                ...
                'mekkah_or_madinah_first' => $data['mekkah_or_madinah_first'] ?? $privateEnquiry->mekkah_or_madinah_first,
                'no_of_nights_mekkah' => $data['no_of_nights_mekkah'] ?? $privateEnquiry->no_of_nights_mekkah,
                'hotel_mekkah' => $data['hotel_mekkah'] ?? $privateEnquiry->hotel_mekkah,
                'meals_mekkah' => $data['meals_mekkah'] ?? $privateEnquiry->meals_mekkah,
                ...
                'mekkah_tour_with_mutawif' => $data['mekkah_tour_with_mutawif'] ?? $privateEnquiry->mekkah_tour_with_mutawif,
