...
class ManifestRule
{
    public function rules(?int $id = null): array
    {
        return [
            ...
            'documents.train_tickets.*.id' => ['nullable', 'integer', 'exists:model_files,id'],
            ...
            'members.*.receipt_documents.*.id' => ['nullable', 'integer', 'exists:model_files,id'],
            ...
            'manifest_member_receipts.*.receipt_documents.*.id' => ['nullable', 'integer', 'exists:model_files,id'],
