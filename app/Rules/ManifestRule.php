...
class ManifestRule
{
    public function rules(?int $id = null): array
    {
        return [
            ...
            'members.*.manifest_sharing_group_id' => ['nullable', 'integer', 'exists:manifest_sharing_groups,id'],
            'members.*.sharing_group_id' => ['nullable', 'integer', 'exists:manifest_sharing_groups,id'],
            ...
            'rooms.*.members.*.manifest_member_id' => ['nullable', 'integer', 'exists:manifest_members,id'],
    ...
    public function roomRules(): array
    {
        return [
            ...
            'members.*.manifest_member_id' => ['nullable', 'integer', 'exists:manifest_members,id'],
            'members.*.customer_confirmation_member_id' => ['nullable', 'integer', 'exists:customer_confirmation_members,id'],
            'members.*.package_official_id' => ['nullable', 'integer', 'exists:package_officials,id'],
            'members.*.sharing_plan' => ['nullable', 'string', 'in:single,double,triple,quad'],
