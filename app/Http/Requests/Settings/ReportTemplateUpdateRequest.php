...
class ReportTemplateUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'page_margin_preset' => ['nullable', 'string', 'in:narrow,normal,wide'],
            'section_spacing_preset' => ['nullable', 'string', 'in:compact,normal,relaxed'],
            ...
            'logo_file' => ['nullable', 'image', 'mimes:jpeg,jpg,png,gif', 'max:5120'],
            'qr_file' => ['nullable', 'image', 'mimes:jpeg,jpg,png,gif,webp', 'max:5120'],
            'stamp_file' => ['nullable', 'image', 'mimes:jpeg,jpg,png,gif', 'max:5120'],
            'signature_file' => ['nullable', 'image', 'mimes:jpeg,jpg,png,gif', 'max:5120'],
            'custom_stamp_file' => ['nullable', 'image', 'mimes:jpeg,jpg,png,gif', 'max:5120'],
            'custom_signature_file' => ['nullable', 'image', 'mimes:jpeg,jpg,png,gif', 'max:5120'],
    ...
    public function messages(): array
    {
        return [
            ...
            'page_margin_preset.in' => 'Page margin preset must be narrow, normal, or wide.',
            'section_spacing_preset.in' => 'Section spacing preset must be compact, normal, or relaxed.',
