...
class CustomerConfirmationController extends Controller
{
    ...
    public function updateMember(Request $request, string $memberId): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'passport_documents' => ['nullable', 'array'],
            'passport_documents.*.id' => ['nullable', 'integer'],
            'passport_documents.*.file' => ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:5120'],
            'passport_documents.*.file_name' => ['nullable', 'string', 'max:255'],
            'passport_documents.*.file_path' => ['nullable', 'string', 'max:255'],
            'passport_documents.*.removed' => ['nullable', 'boolean'],
            'photo_documents' => ['nullable', 'array'],
            'photo_documents.*.id' => ['nullable', 'integer'],
            'photo_documents.*.file' => ['nullable', 'file', 'mimes:jpg,jpeg,png', 'max:5120'],
            ...
            'passport_documents.*.file.mimes' => 'Passport attachment must be JPG, JPEG, PNG, or PDF.',
